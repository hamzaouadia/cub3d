...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/30 11:22:54 by smounafi          #+#    #+#             */
/*   Updated: 2023/07/30 11:22:56 by smounafi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_cross(int key_code, t_map *map)
{
	(void)key_code;
	(void)map;
...
void	initialize_window(t_window *win, t_map *map)
{
	...
	mlx_hook(win->win, 17, 0, ft_cross, map);
	mlx_loop(win->mlx);
}
