...
SRC =	cub3D.c cub3D_helper.c cub3D_helper2.c cub3D_helper3.c render.c render_helper.c gun_textures.c\
...
$(NAME) : $(OBJ)
	$(CC) $(CFLAGS) $^ -lpthread -Ofast -lmlx -framework OpenGL -framework AppKit -o $@
